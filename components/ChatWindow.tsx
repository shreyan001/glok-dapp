    ...
    <div className={`flex flex-col items-center p-4 md:p-8 rounded grow overflow-hidden ${(messages.length > 0 ? "border" : "")}`}>
            ...
            .map((m, i) => {
              ...
              return (
                <ChatMessageBubble
                  ...
                  message={m}
                  aiEmoji={emoji}
                  modalState={transactionModalOpen}
                  openTransactionModal={openTransactionModal} // Pass function to ChatMessageBubble
                ></ChatMessageBubble>
              );
            })
        ) : (
      ...
      <form onSubmit={sendMessage} className="flex w-full flex-col">
        ...
        <div className="flex w-full mt-4">
          <input
            className="grow mr-8 p-4 border bg-slate-50 border-black rounded"
            value={input}
            placeholder={placeholder ?? "What's it like to be a pirate?"}
            onChange={handleInputChange}
          />
          <button type="submit" className="shrink-0 px-8 py-4 bg-blue-300 rounded w-28">
      ...
      <TransactionModal
        ...
        onClose={() => {
          ...
          handleShowFullMessage(); // Call the function to update showFullMessage state
        }}
